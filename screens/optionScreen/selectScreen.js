        ...
        >
          <ScrollView showsVerticalScrollIndicator={true}>
            <Text style={styles.describeQuizText}>
              ...
              personal growth. The content and techniques offered by the App are
              intended to complement, not replace, professional medical advice,
              diagnosis, or treatment. It is essential to consult with a
              qualified healthcare provider before making any changes to your
              health regimen.
              {"\n\n"}
              ...
              {"\n\n"}
              Individuals with pre-existing medical or psychological conditions
              should exercise caution when using the App. If you have any
              concerns about the suitability of the meditation and healing
              practices for your specific circumstances, it is recommended that
              you consult with a qualified healthcare professional before
              proceeding.
              {"\n\n"}
              ...
              guaranteed, and any benefits experienced may differ from person to
              person.
              {"\n\n"}
              The App's content may include guided imagery, relaxation
              exercises, and meditation techniques that encourage introspection
              and emotional exploration. It's important to note that engaging in
              these practices can sometimes bring up unexpected emotions or
              thoughts. If you find yourself experiencing discomfort, distress,
              or psychological discomfort during or after using the App,
              consider discontinuing use and seeking professional assistance if
              needed.
              {"\n\n"}
              The App is meant to be used in a safe and appropriate environment.
              Do not engage with the App's content while operating machinery,
              driving, or participating in any activity that requires your full
              attention.
              {"\n\n"}
              ...
              content creators, and platform providers shall not be held liable
              for any direct, indirect, incidental, consequential, or special
              damages arising from your use of the App or reliance on any
              information provided.
              {"\n\n"}
              Remember that healing is a complex and individualized process. The
              App's practices are intended to be part of a holistic approach to
              well-being and should be used as such. Consistent practice and
              patience are often necessary to experience the full benefits of
              ...
              {"\n"}
              During your usage of this app, you might encounter mood and mental
              health surveys. One common survey used is the Patient Health
              Questionnaire-9 (PHQ-9), which assesses levels of anxiety and
              depression according to medical standards. However, please be
              aware that the results of these surveys are provided for
              informational purposes only and cannot replace the evaluation of a
              ...
              necessary. Remember, your mental well-being is a priority. If you
              have any concerns about your mental health, seeking assistance
              from trained professionals is the best course of action.
            </Text>
          </ScrollView>
          {startQuizBtn()}
        </View>
