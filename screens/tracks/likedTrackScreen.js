...
import { useGetAudioForLikedTracksAPI } from "../../hooks/playlistTracks.hook";
...
const LikedTracksScreen = ({ navigation }) => {
  ...
  const { data: dataTracksFromPlaylist, isSuccess: successTracksFromPlaylist } =
    useGetAudioForLikedTracksAPI();
