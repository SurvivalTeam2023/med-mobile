...
const SettingsScreen = ({ navigation }) => {
  const signout = async () => {
    return await axios
      .post(
        "http://dev.mediatation.tokyo/api/auth/users/logout",
        {},
        {
          headers: {
    ...
    return (
      ...
      >
        ...
        <Switch
          ...
          onValueChange={() =>
            updateState({
              playBackWhenDeviceConnect: !playBackWhenDeviceConnect,
            })
          }
        />
      </View>
    ...
    return (
      ...
      >
        ...
        <Switch
          ...
          onValueChange={() =>
            updateState({ musicWithScreenOff: !musicWithScreenOff })
          }
        />
      </View>
    );
    ...
    return (
      ...
      >
        ...
        <Switch
          ...
          onValueChange={() =>
            updateState({ skipSlienceBetweenTracks: !skipSlienceBetweenTracks })
          }
        />
      </View>
    );
    ...
    return (
      ...
      >
        ...
        <Switch
          ...
          onValueChange={() =>
            updateState({ audioNormalization: !audioNormalization })
          }
        />
      </View>
    );
