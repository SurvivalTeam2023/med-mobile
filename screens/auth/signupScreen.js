...
const SignupScreen = ({ navigation }) => {
  ...
  const { showPassword, username, phoneNumber, email, password } = state;
  ...
  function usernameTextField() {
    return (
      <View style={[styles.textFieldWrapStyle, styles.userName]}>
        <MaterialIcons name="badge" color={Colors.grayColor} size={20} />
        <TextInput
